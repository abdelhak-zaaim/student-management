...
import static com.student.management.domain.PaymentAsserts.*;
...
class PaymentResourceIT {
    ...
    private static final Status DEFAULT_STATUS = Status.SUBMITED;
    ...
    public static Payment createEntity() {
        return new Payment().amount(DEFAULT_AMOUNT).status(DEFAULT_STATUS).date(DEFAULT_DATE);
    }
    ...
    public static Payment createUpdatedEntity() {
        return new Payment().amount(UPDATED_AMOUNT).status(UPDATED_STATUS).date(UPDATED_DATE);
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.amount(UPDATED_AMOUNT).status(UPDATED_STATUS).date(UPDATED_DATE);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.amount(UPDATED_AMOUNT).status(UPDATED_STATUS).date(UPDATED_DATE);
