...
public class StudentManagementProperties {
    ...
    public StudentManagementProperties() {
    }
    ...
    public static class Cache {
        ...
        public static class Redis {
            ...
            public Redis() {
                this.server = tech.jhipster.config.JHipsterDefaults.Cache.Redis.server;
                this.expiration = 300;
                this.cluster = false;
    ...
    public static class ApiDocs {
        ...
        public ApiDocs() {
            this.termsOfServiceUrl = tech.jhipster.config.JHipsterDefaults.ApiDocs.termsOfServiceUrl;
            this.contactName = tech.jhipster.config.JHipsterDefaults.ApiDocs.contactName;
            this.contactUrl = tech.jhipster.config.JHipsterDefaults.ApiDocs.contactUrl;
            this.contactEmail = tech.jhipster.config.JHipsterDefaults.ApiDocs.contactEmail;
            this.license = tech.jhipster.config.JHipsterDefaults.ApiDocs.license;
            this.licenseUrl = tech.jhipster.config.JHipsterDefaults.ApiDocs.licenseUrl;
            this.defaultIncludePattern = tech.jhipster.config.JHipsterDefaults.ApiDocs.defaultIncludePattern;
            this.managementIncludePattern = tech.jhipster.config.JHipsterDefaults.ApiDocs.managementIncludePattern;
    ...
    public static class Gateway {
        ...
        public Gateway() {
            this.authorizedMicroservicesEndpoints = tech.jhipster.config.JHipsterDefaults.Gateway.authorizedMicroservicesEndpoints;
        }
    ...
    public static class Registry {
        ...
        public Registry() {
            this.password = tech.jhipster.config.JHipsterDefaults.Registry.password;
        }
